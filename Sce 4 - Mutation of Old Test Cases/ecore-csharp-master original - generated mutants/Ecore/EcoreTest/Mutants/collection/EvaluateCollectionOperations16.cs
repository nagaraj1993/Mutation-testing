...
//        {
//            // Arrangement
//            var expectedResult = new Sequence<object>{ "a", "b", 1 };
//            // Action
//            var actualResult = new Sequence<object> { "a", "b"}.append(1);
//            /*	EXCEPTION: org.eclipse.ocl.SemanticException 
//		    	Cannot find operation (append(Integer)) for the type (Sequence(String))  */
//            //Problem with OCL interpreter
//            // Assertion 
