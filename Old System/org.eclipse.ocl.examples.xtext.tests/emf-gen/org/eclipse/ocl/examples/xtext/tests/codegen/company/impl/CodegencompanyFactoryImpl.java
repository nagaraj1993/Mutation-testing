...
public class CodegencompanyFactoryImpl extends EFactoryImpl implements CodegencompanyFactory {
	...
	public static CodegencompanyFactory init() {
		try {
			CodegencompanyFactory theCodegencompanyFactory = (CodegencompanyFactory)EPackage.Registry.INSTANCE.getEFactory(CodegencompanyPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public @NonNull CompanySizeKind createCompanySizeKindFromString(EDataType eDataType, String initialValue) {
