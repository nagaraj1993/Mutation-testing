...
//        {
//            // Arrangement
//            var expectedResult = Convert.ToBoolean((4) / Convert.ToDouble(2)) + 5 * 3;
//            // Action
//            var actualResult = Convert.ToBoolean((4) / Convert.ToDouble(2)) + ((Func<int>)(() => { var a = 5; return a * 3; }))();
//            ;
//            // Assertion 
//            ocl.assertQueryEquals(expectedResult, actualResult);
//        }
...
//        {
//            // Arrangement
//            var expectedResult = Convert.ToBoolean((4) / Convert.ToDouble(2)) + 3 * 5 * 7;
//            // Action
//            var actualResult = Convert.ToBoolean((4) / Convert.ToDouble(2)) + ((Func<int>)(() => {
