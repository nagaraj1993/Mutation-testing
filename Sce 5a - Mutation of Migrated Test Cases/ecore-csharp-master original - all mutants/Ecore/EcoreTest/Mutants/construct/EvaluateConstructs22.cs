...
//            // Action
//            //Original
//            //var actualResult = Convert.ToDouble(4)/ Convert.ToDouble(2) + ((Func<int>)(() => { var a = 5; return 3 * ((Func<int>)(() => { var b = 7; return a * b; }))(); }))();
//            //Mutant22
//            var actualResult = Convert.ToUInt64(4)/ Convert.ToDouble(2) + ((Func<int>)(() => { var a = 5; return 3 * ((Func<int>)(() => { var b = 7; return a * b; }))(); }))();
//		    // Assertion 
//		    ocl.assertQueryEquals(expectedResult, actualResult);
//		}
