...
//		// Arrangement
//		    var expectedResult = new Sequence<int>{1,2, 3,4, 4};
//            // Action
//            //Original
//            //var actualResult = new Sequence<int>{1,2,3,4}.including(4);
//            //Mutant12
//            var actualResult = new Sequence<int>{1,2,3,4}.excluding(4);
//		// Assertion 
//		    ocl.assertQueryResults(expectedResult, actualResult);
//		}
